...
interface LocationSearchInputWithCallbackProps {
  value: { code: string; name: string } | null;
  onChange: (location: { code: string; name: string }) => void;
  placeholder?: string;
  locationType?: 'CITIES_AND_AIRPORTS' | 'SALES_CITIES';
  label?: string;
}

const LocationSearchInputWithCallback: React.FC<LocationSearchInputWithCallbackProps> = ({
  value,
  onChange,
...
export default LocationSearchInputWithCallback;
