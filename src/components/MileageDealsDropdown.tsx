...
const MileageDealsDropdown: React.FC<MileageDealsDropdownProps> = ({ deals, onSelectDeal }) => {
            ...
            <div className="max-h-96 overflow-y-auto">
              {deals.map((deal, index) => (
                <button
                  ...
                  className="w-full px-4 py-3 hover:bg-gray-700 transition-colors text-left border-b border-gray-700 last:border-b-0"
                >
